---
title: "U.S.-based Regional Airline Pilot Retention Analysis"
subtitle: "General Factor Rankings and Subfactor Priorities (n=57)"
author:
...
This analysis examines pilot retention priorities from a survey of U.S.-based regional airline pilots (n = 57).
...
![Factors of Pilot Retention in U.S.-based Regional Airlines](../../documentation/elements_of_retention.png){#fig-retention-factors}

# Statistical Methods

## Sample and Data Collection

Survey data was collected from U.S.-based regional airline pilots during April and May 2025. After exclusions for incomplete responses and non-regional airline pilots, n = 57 valid responses remained for analysis.
...
**General Factor Analysis (24 tests):** Benjamini-Hochberg FDR at q = 0.10 applied across all demographic comparisons (6 factors x 4 demographics).
...
**Code Availability:** The complete analysis code is available at `scripts/analysis/unified_retention_analysis-mod57.qmd` in the [GitHub repository][repo-url].
...
# ============================================================================
# SAMPLE: U.S.-based Regional Airlines
# ============================================================================
# Include only U.S.-based regional airline pilots

included_data <- included_data %>%
  filter(str_detect(air_carrier_type, "Regional"))

# Verify sample filter
regional_n <- nrow(included_data)
```

::: {.callout-note}
## Sample
This analysis includes **U.S.-based regional airline pilots** (n = `r nrow(included_data)`).
:::
...
rank_cols <- c("financial_rank", "qol_rank", "professional_rank",
...
2.  Quality of Life (schedule, family, work-life balance)
...
# Mann-Whitney U tests (EXACT due to small female n=5)
...
::: {.callout-note}
## Not Applicable
Carrier type comparison is not applicable as all 57 pilots in this sample are employed at U.S.-based regional airlines.
:::

```{r}
#| label: rq2f-carrier
#| output: false
# NOTE: Carrier type comparison not applicable - all pilots are regional
...
# Create subfactor output directories
dir.create(
...
The sample of n = 57 provides adequate power only for detecting large effects. For demographic comparisons:
