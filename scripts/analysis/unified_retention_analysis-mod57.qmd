...
| Comparison | Approximate Group Sizes | Detectable Effect (80% power) |
|------------|------------------------|-------------------------------|
| Age groups | ~43 vs ~14 | Large (r > 0.45) |
| Experience | ~14 per quartile | Very large (eta-squared > 0.14) |
| Gender | ~52 vs ~5 | Very large only (r > 0.7) |
| Military | ~25 vs ~32 | Medium-large (r approx 0.40) |
| Position | ~33 vs ~24 | Medium-large (r approx 0.40) |

**Note**: Group sizes are approximate and computed from the regional subset. The reduction from n=76 to n=57 further limits statistical power, particularly for already-small subgroups.

**Gender comparisons warrant particular caution**: With approximately 5 female respondents in the regional subset, the analysis has very low power to detect even large effects - most true gender differences would go undetected.
