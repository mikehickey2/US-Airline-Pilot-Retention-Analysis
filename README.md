...
**Phase 1A: Subfactor Analysis Complete (November 2025):** Comprehensive analysis of 31 subfactor rankings across all six retention constructs completed with the following findings: - Analyzed all subfactors (Financial, QoL, Professional, Recognition, Schedule, Operational) - Compared rankings across 5 demographic groups (age, gender, position, military experience, experience quartiles) - Applied non-parametric tests with Bonferroni corrections (155 total tests) - **Key finding:** No significant demographic differences detected in subfactor priorities (p.adj \< 0.05) - All outputs use readable labels from survey instrument - New analysis file: `scripts/analysis/subfactor_analysis.qmd`
